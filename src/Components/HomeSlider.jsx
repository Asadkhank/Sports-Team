...
import sliderprofile from "../assets/sliderprofile.jpg";
          ...
          <SwiperSlide key={index}>
            ...
            >
              <div className="relative mx-2  flex items-center">
                <div className="h-20 w-12 sm:h-24 sm:w-16 absolute bg-[#eb9834] border-t border-t-[#2527ae] border-t-8 flex items-center justify-center left-0 z-10">
